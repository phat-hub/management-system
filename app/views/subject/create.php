    ...
    <div class="row p-3 rounded-2">
      <div class="col-md-6 offset-md-3 p-3">
        <div class="bg-white p-4 rounded-2 shadow-lg">
          <h2 class="text-center fw-bold mb-4">Thêm học phần mới</h2>
          <form class="row g-3" method="post" action="/subject/create">
            ...
            <div class="form-group col-12">
              ...
              <input 
                ...
                value="<?= isset($old['subjectCode']) ? $this->e($old['subjectCode']) : '' ?>" 
              >
            ...
            <div class="form-group col-12">
              ...
              <input 
                ...
                value="<?= isset($old['subjectName']) ? $this->e($old['subjectName']) : '' ?>" 
              >
            ...
            <div class="form-group col-12">
              ...
              <input 
                ...
                value="<?= isset($old['credits']) ? $this->e($old['credits']) : '' ?>"
              >
