...
<div class="container py-5">
  <div class="bg-white p-5 rounded-3 shadow-lg">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="fw-bold mb-0">Danh sách học phần</h2>
        ...
        <tbody>
          <?php foreach ($subjects as $subject) : ?>
            <tr>
              ...
              <td><?= ucfirst($subject->subjectName) ?></td>
              <td><?= ucfirst($subject->credits) ?></td>
              <td>
                <a href="/subject/edit/<?= $subject->id ?>" class="btn btn-sm btn-warning me-1">
                  <i class="bi bi-pencil-square"></i> Sửa
                </a>
                <form method="POST" action="/subject/delete/<?= $subject->id ?>" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa?');">
