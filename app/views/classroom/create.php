    ...
    <div class="row p-3 rounded-2">
      <div class="col-md-6 offset-md-3 p-3">
        <div class="bg-white p-4 rounded-2 shadow-lg">
          <h2 class="text-center fw-bold mb-4">Thêm phòng học mới</h2>
          <form class="row g-3" method="post" action="/classroom/create">
            ...
            <div class="form-group col-12">
              ...
              <input 
                ...
                value="<?= isset($old['classroomName']) ? $this->e($old['classroomName']) : '' ?>" 
              >
            ...
            <div class="form-group col-12">
              ...
              <input 
                ...
                value="<?= isset($old['capacity']) ? $this->e($old['capacity']) : '' ?>" 
              >
