    ...
    <div class="row p-3 rounded-2">
      <div class="col-md-8 offset-md-2 p-3">
        <div class="bg-white p-4 rounded-2 shadow-lg">
          <h2 class="text-center fw-bold mb-4">Chỉnh sửa thông tin giảng viên</h2>
          <form class="row g-3" method="post" action="/lecturer/edit/<?= $this->e($lecturer->id) ?>">
            ...
            <div class="form-group col-md-6">
              ...
              <input 
                ...
                value="<?= isset($old['peopleId']) ? $this->e($old['peopleId']) : $this->e($lecturer->peopleId) ?>"
                <?= !$is_admin ? 'readonly' : '' ?>
              >
            ...
            <div class="form-group col-md-6">
              ...
              <input 
                ...
                value="<?= isset($old['name']) ? $this->e($old['name']) : $this->e($lecturer->name) ?>"
                <?= !$is_admin ? 'readonly' : '' ?>
              >
            ...
            <div class="form-group col-md-6">
              ...
              <input 
                ...
                value="<?= isset($old['dob']) ? $this->e($old['dob']) : $this->e($lecturer->dob) ?>"
              >
            ...
            <div class="form-group col-md-6">
              ...
              <select id="gender" name="gender" class="form-select <?= isset($errors['gender']) ? 'is-invalid' : '' ?>" <?= !$is_admin ? 'disabled' : '' ?>>
                <option value="Nam" <?= (isset($old['gender']) ? $old['gender'] : $lecturer->gender) == 'Nam' ? 'selected' : '' ?>>Nam</option>
                <option value="Nữ" <?= (isset($old['gender']) ? $old['gender'] : $lecturer->gender) == 'Nữ' ? 'selected' : '' ?>>Nữ</option>
              </select>
              <?php if (!$is_admin): ?>
                <input type="hidden" name="gender" value="<?= isset($old['gender']) ? $this->e($old['gender']) : $this->e($lecturer->gender) ?>">
              <?php endif ?>
            ...
            <div class="form-group col-md-6">
              ...
              <input 
                ...
                value="<?= isset($old['hometown']) ? $this->e($old['hometown']) : $this->e($lecturer->hometown) ?>"
              >
            ...
            <div class="form-group col-md-6">
              ...
              <input 
                ...
                value="<?= isset($old['phone']) ? $this->e($old['phone']) : $this->e($lecturer->phone) ?>"
              >
            ...
            <div class="form-group col-md-6">
              ...
              <select id="department_id" name="department_id" class="form-select <?= isset($errors['department_id']) ? 'is-invalid' : '' ?>" <?= !$is_admin ? 'disabled' : '' ?>>
                <?php foreach ($departments as $dept): ?>
                  <option value="<?= $dept->id ?>" 
                    <?= (isset($old['department_id']) ? $old['department_id'] : $lecturer->department_id) == $dept->id ? 'selected' : '' ?>>
                    <?= $this->e($dept->departmentName) ?>
                  </option>
                <?php endforeach; ?>
              </select>
              <?php if (!$is_admin): ?>
                <input type="hidden" name="department_id" value="<?= isset($old['department_id']) ? $this->e($old['department_id']) : $this->e($lecturer->department_id) ?>">
              <?php endif ?>
