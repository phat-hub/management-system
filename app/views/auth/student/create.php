    ...
    <div class="row p-3 rounded-2">
      <div class="col-md-6 offset-md-3 p-3">
        <div class="bg-white p-4 rounded-2 shadow-lg">
          <h2 class="text-center fw-bold mb-4">Thêm tài khoản sinh viên</h2>
          <form class="row g-3" method="post" action="/student/register">
            ...
            <div class="form-group col-12">
              ...
              <select 
                id="major_id" 
                name="major_id" 
                class="form-select <?= isset($errors['major_id']) ? 'is-invalid' : '' ?>"
              >
